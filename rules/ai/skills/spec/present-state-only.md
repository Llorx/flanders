...
- The spec validator additionally gates this obligation, per `rules/ai/skills/spec/final-validator.md`. The active prohibition and the validator check are complementary, not alternatives.
