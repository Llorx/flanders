...
- The working tree must have no unstaged changes except for the plan file selected for this run. Staged changes are permitted: they are left in the index untouched, they form the run baseline defined below, and they are folded into the first accepted task's commit.
