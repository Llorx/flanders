...
5. **Present the diagnosis.** The skill presents its root-cause finding and its recommendation in chat, as its own chat message delivered before the launch question of the Recommending and launching the next step section, per [.spec/contracts/ai-skills/report-before-question.md](/.spec/contracts/ai-skills/report-before-question.md). This is the skill's sole deliverable; the skill writes no file of its own.
