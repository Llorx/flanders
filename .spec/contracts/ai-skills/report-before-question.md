...
## Purpose
Pin the ordering between a skill's substantive chat deliverables and the questions it puts to the user: a deliverable owed in chat is delivered as its own chat message before the question it precedes, and the question never substitutes for it. This contract governs only that ordering; how questions are grouped and presented is governed by [.spec/contracts/ai-skills/clarification-question-cadence.md](/.spec/contracts/ai-skills/clarification-question-cadence.md), and which deliverables a skill owes is governed by each skill's own contract.
