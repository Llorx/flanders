...
## Purpose
Pin the natural language the `/flanders-spec`, `/flanders-plan`, `/flanders-work`, and `/flanders-hard-stop-review` skills use when they converse with the user. This is the language of the conversation itself, distinct from the language any files a skill persists are written in.
