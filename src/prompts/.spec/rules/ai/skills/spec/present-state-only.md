...
- The spec validator additionally gates this obligation, per [src/prompts/.spec/rules/ai/skills/spec/final-validator.md](/src/prompts/.spec/rules/ai/skills/spec/final-validator.md). The active prohibition and the validator check are complementary, not alternatives.
