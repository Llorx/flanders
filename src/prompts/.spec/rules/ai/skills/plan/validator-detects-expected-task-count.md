...
- The validator counts every line in the plan that matches the canonical task-line recognizer regex pinned in [src/prompts/.spec/rules/ai/skills/plan/validator-matches-task-line-regex.md](/src/prompts/.spec/rules/ai/skills/plan/validator-matches-task-line-regex.md).
