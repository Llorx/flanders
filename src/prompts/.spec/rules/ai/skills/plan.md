...
- A task fixes an internal mechanism — names a specific helper to reuse, a function, type, or file to leave untouched, or code to treat as out of scope — that no observable acceptance criterion and no explicitly required architectural property needs.
