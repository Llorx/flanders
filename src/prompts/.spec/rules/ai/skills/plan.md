...
A task-reference pair missing its record is unaudited, and the validator does not report category 4 as passed while any pair is unaudited; a summary clause that disposes of several pairs at once leaves every pair it covers unaudited.
