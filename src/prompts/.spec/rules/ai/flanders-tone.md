...
- **Subject:** the construction of every Flanders-authored prompt whose agent or skill streams or prints natural-language narration to the user:
  ...
  - the `/flanders-spec`, `/flanders-plan`, `/flanders-implement`, and `/flanders-hard-stop-review` skill artifact bodies, for the messages those skills address to the user.
