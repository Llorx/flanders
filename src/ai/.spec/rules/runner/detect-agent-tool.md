...
3. The runner invokes the resulting tool with that model and effort, per [src/ai/.spec/rules/runner/claude-invocation.md](/src/ai/.spec/rules/runner/claude-invocation.md) or [src/ai/.spec/rules/runner/codex-invocation.md](/src/ai/.spec/rules/runner/codex-invocation.md).
