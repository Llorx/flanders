...
- **Subject:** every per-tool adapter — today the Claude adapter ([src/ai/.spec/rules/runner/claude-invocation.md](/src/ai/.spec/rules/runner/claude-invocation.md)) and the Codex adapter ([src/ai/.spec/rules/runner/codex-invocation.md](/src/ai/.spec/rules/runner/codex-invocation.md)), and any adapter added later. Each adapter realizes this obligation through the specific flags and input handling of its own binary, pinned in that adapter's rule.
