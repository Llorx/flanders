// The set of model identifiers that support Claude Code's fast mode — exactly the Opus 5, Opus 4.8,
// and Opus 4.7 catalog entries and their 1M-context variants, plus the auto-updating `Latest Opus`
// alias (and its 1M variant), which resolve to a fast-capable Opus. This is the single definition of the
...
// eight `FAST_CAPABLE_MODELS` identifiers and false for every other value — `best`, Opus 4.6 and
