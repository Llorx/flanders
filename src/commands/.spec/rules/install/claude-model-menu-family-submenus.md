...
3. The synthetic `default configured model` entry pinned in [src/commands/.spec/rules/install/model-list-discovery.md](/src/commands/.spec/rules/install/model-list-discovery.md).
4. The custom entry pinned in [src/commands/.spec/rules/install/claude-lists-include-custom-value-entry.md](/src/commands/.spec/rules/install/claude-lists-include-custom-value-entry.md), as the final entry.

The custom entry remains the final top-level entry, after the `default configured model` entry, consistent with [src/commands/.spec/rules/install/claude-lists-include-custom-value-entry.md](/src/commands/.spec/rules/install/claude-lists-include-custom-value-entry.md).
...
- The family grouping is applied to the `codex` model question, which is flat per [src/commands/.spec/rules/install/model-list-discovery.md](/src/commands/.spec/rules/install/model-list-discovery.md).
