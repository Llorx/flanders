...
## Authority
- `contracts/` is writable only via the `/flanders-contract` skill (see `ai-skills/contract-skill.md`).
- `rules/` is writable only via the `/flanders-rule` skill (see `ai-skills/rule-skill.md`).
