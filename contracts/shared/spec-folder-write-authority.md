...
## Authority
- `contracts/` is writable only via the `/flanders-spec` skill (see `ai-skills/spec-skill.md`).
- `rules/` is writable only via the `/flanders-spec` skill (see `ai-skills/spec-skill.md`).
