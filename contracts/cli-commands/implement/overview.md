...
6. When the git integration is active (see `cli-commands/implement/git-integration.md`), run the git preflight check. If the preflight fails, exit non-zero before setting up any workspace.
