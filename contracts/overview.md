...
- Two **AI-tool skills**, invoked from inside an AI-coding-tool session. Each skill owns its own contract under `ai-skills/`:
  - `/flanders-spec` — authors contracts and rules; see `ai-skills/spec-skill.md`.
